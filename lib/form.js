...
var Form = Class.extend({
    ...
    setupFormHandler: function setupFormHandler(req, res, callback, err, values, options) {
        ...
        if (req.method === 'GET' && values && values._csrf) {
        ...
        if (req.xhr) {
            this.options.getValues(req, res, function (err, formValues) {
                if (this.options.redirectUrl) {
                    ...
                    formObject.values = Object.keys(formValues).length !== 0 ? formValues : req.forms[this.formName].values;
    ...
    htmlErrors: function htmlErrors(err, form) {
        if (this.options.htmlErrors) {
    ...
    errorHandler: function errorHandler(err, req, res, next) {
        ...
        if (req.xhr) {
            formObject.errorMessage = this.htmlErrors(err, form);
    ...
    fieldHtml: function fieldHtml(field, value, options) {
        return utils.htmlTag(
            ...
            field.html(value, options, this._fields)
        );
    },
