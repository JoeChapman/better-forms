...
var Form = Class.extend({
    ...
    retrieve: function retrieve(req, res, callback) {
        var values, options = { renderErrors: false, renderSuccess: false, fieldWrapperTagName: this.options.fieldWrapperTagName };
        if (req.method === 'POST') {
        ...
        if (req.xhr) {
            this.options.getValues(req, res, function (err, formValues) {
                if (this.options.redirectUrl) {
                    res.json(200, { redirect: this.options.redirectUrl });
                } else {
