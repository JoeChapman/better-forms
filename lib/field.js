...
module.exports = Class.extend({
    ...
    constructor: function Field(props, options) {
    ...
    validationMessageAttributes: function validationMessageAttributes() {
        ...
        if (this.dataMessages === false || (this.options && this.options.dataMessages === false)) {
            return;
        }
    ...
    isReady: function isReady(field, not) {
